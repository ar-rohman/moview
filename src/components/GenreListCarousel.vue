            ...
            <carousel-card>
                <div class="flex gap-x-4">
                    <button
                        ...
                        :key="genre.id"
                        class="px-4 py-2 rounded-2xl whitespace-nowrap border border-red-500 dark:border-red-600 text-red-500 dark:text-red-600 hover:text-white dark:hover:text-white hover:bg-red-500 dark:hover:bg-red-500 focus:outline-none focus-visible:ring-red-400 focus-visible:ring-2 select-none min-w-0"
