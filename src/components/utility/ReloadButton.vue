<template>
    <button
        class="flex items-center justify-center text-red-500 dark:text-red-600 transform transition motion-safe:hover:scale-110 duration-500 focus:outline-none focus-visible:ring-red-400 focus-visible:ring-2 focus-visible:rounded-lg"
