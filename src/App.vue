<template>
    <q-layout view="lhh lpr lff">
        <q-header reveal zbordered class="bg-white text-blue-grey-9 q-py-sm zq-px-lg">
            <q-toolbar
                class="row full-width justify-between items-center content-center q-gutter-x-xl">
                <q-btn dense flat round icon="mdi-text" zzpadding="sm" @click="toggleDrawer" />
                <q-input
                    v-model="text"
                    rounded
                    outlined
